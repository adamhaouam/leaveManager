...
describe('DeleteTask Function Test', () => {
  ...
  it('should return 404 if task is not found', async () => {
    // Stub Task.findByIdAndDelete to return null
    const findByIdAndDeleteStub = sinon.stub(Task, 'findByIdAndDelete').resolves(null);
  ...
  it('should return 500 if an error occurs', async () => {
    // Stub Task.findByIdAndDelete to throw an error
    const findByIdAndDeleteStub = sinon.stub(Task, 'findByIdAndDelete').throws(new Error('DB Error'));
